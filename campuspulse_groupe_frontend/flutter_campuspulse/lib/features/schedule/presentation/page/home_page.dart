...
class _HomePageState extends State<HomePage>
  ...
  // ── Header avec logo UADB + nom étudiant + déconnexion ──
  Widget _buildHeader() {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('Votre agenda universitaire', style: TextStyle(
  ...
  Widget _buildStatsRow() {
    return Row(children: [
      ...
      Expanded(child: _statCard('Départ.',    _department.length > 5
          ? _department.substring(0,5) : _department,
  ...
  Widget _buildQuickActions(BuildContext context) {
    return Row(children: [
      Expanded(child: _quickAction(context, Icons.calendar_today,
          'Calendrier', const Color(0xFF1A3A6B), () {
        Navigator.push(context,
            MaterialPageRoute(builder: (_) => const SchedulePage()));
      })),
      const SizedBox(width: 12),
      Expanded(child: _quickAction(context, Icons.notifications_outlined,
          'Rappels', Colors.orange, () {
